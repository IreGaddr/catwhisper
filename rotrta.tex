...
cross-vendor GPU vector similarity search library built on Vulkan.  Starting
...
\begin{IEEEkeywords}
test-driven development, performance engineering, vector similarity search,
...
CatWhisper is a C++ GPU vector similarity search library targeting
...
similarity search library, achieving a \SI{17.7}{\times}--\SI{67.1}{\times}
